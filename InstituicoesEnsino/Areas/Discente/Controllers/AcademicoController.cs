...
using InstituicoesEnsino.Data.DAL.Discente;
...
namespace InstituicoesEnsino.Areas.Discente.Controllers
{
    [Area("Discente")]
    [Authorize]
    public class AcademicoController : Controller
    {
        ...
        public AcademicoController(Context context, IWebHostEnvironment env)
        {
            _context = context;
        ...
        public async Task<IActionResult> DownloadFoto(long id)
        {
            ...
            FileStream stream = new FileStream(System.IO.Path.Combine(_env.WebRootPath, nomeArquivo), FileMode.Create, FileAccess.Write);
            stream.Write(academico.Foto, 0, academico.Foto.Length);
            stream.Close();
